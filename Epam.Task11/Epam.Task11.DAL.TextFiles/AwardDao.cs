...
namespace Epam.Task7.DAL.TextFiles
{
    ...
    {
        internal const string ImageFolder = "awardImage";
        ...
        internal static string AwardAsTxt(Award award)
        {
            return $"{award.Id}{InfoSeparator}{award.Title}{InfoSeparator}{award.Image != null}";
        }
